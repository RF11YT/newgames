...
import bannerGeracoes from "@/assets/banner-geracoes.png.asset.json";
import bannerRetroFuturo from "@/assets/banner-retro-futuro.png.asset.json";
import { waGeral, waLink } from "@/lib/whatsapp";
import { WhatsAppIcon } from "./WhatsAppIcon";

const banners = [
  {
    imagem: bannerRetroFuturo.url,
